...
<div id="navbar"></div>
  <script src="/nav/nav.js"></script><br>
    <div class="container text-center">
        ...
        $coordinatesQuery = "SELECT username FROM coordinates WHERE latitude = $latitude AND longitude = $longitude";
        ...
        if ($coordinatesResult->num_rows > 0) {
            ...
            if ($usersResult->num_rows > 0) {
                ...
                echo '<button class="btn btn-success" onclick="parked()">I have successfully parked</button>';
            } else {
